...
// The Reviews page on a custom domain — lists every customer review authored on
// the home testimonials section. Served at /reviews (never at root).
export default async function CustomDomainReviewsPage({
  ...
  return <ReviewsPage agencySlug={agencySlug} basePath="" />;
}
